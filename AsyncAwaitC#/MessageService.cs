...
public class MessageService{
    ...
    {
        System.Console.WriteLine("MessageService : Sending an email..."+ e.Video.Title);
    }
     public void OnVideoDeleted(object source,VideoEventArgs e)
    {
        System.Console.WriteLine("MessageService : Sending an email of video deleted..." + e.Video.Title);
    }
}